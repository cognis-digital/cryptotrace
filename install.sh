#!/usr/bin/env sh
# Universal installer for cryptotrace. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/cryptotrace.git"
echo "Installing cryptotrace ..."
...
echo "Done. Run: cryptotrace --help"
